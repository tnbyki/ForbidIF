...
(function () {
    ...
    const TEXTS = [
        ...
        ['A6', '彼女の右足を ',     '彼女の左足を ', '汚い','と話す'],
        ['ゆっくり ', 'ふつうに ','はやく ', '激しく ', '半分 ','優しく ']
    ];
...
function makeButton(label, onClick, options = {}) {
    ...
    let tip = document.getElementById('gemini-select-inputer-tooltip');
    if (tip) return tip;

    tip = document.createElement('div');
    tip.id = 'gemini-select-inputer-tooltip';
    tip.style.position = 'fixed';
    tip.style.zIndex = '9999999';
    tip.style.pointerEvents = 'none';
    tip.style.background = 'rgba(0,0,0,0.92)';
    tip.style.color = '#fff';
    tip.style.border = '1px solid #555';
